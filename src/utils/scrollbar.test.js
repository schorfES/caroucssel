	...
	describe('Scrollbar instance', () => {
		...
		describe('dimensions', () => {
			it('should return when scrollbar is added to the inner viewport', () => {
				...
				document.createElement = jest.fn(function (...args) {
					const callCount = this.createElement.mock.calls.length;
					...
					const mockedClientHeight = jest.fn(() => isInner ? 75 : 50);
					const mockedOffsetHeight = jest.fn(() => isInner ? 75 : 50);
			...
			it('should return when scrollbar is added to the outer viewport', () => {
				...
				document.createElement = jest.fn(function (...args) {
					...
					const element = original.apply(document, args);
					const mockedClientHeight = jest.fn(() => isInner ? 75 : 50);
					const mockedOffsetHeight = jest.fn(() => {
